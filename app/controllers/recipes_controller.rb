class RecipesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @recipe.save
        format.html { redirect_to single_recipe_path(@recipe), notice: 'Recipe was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @recipe.update(recipe_params)
        format.html { redirect_to single_recipe_path(@recipe), notice: 'Recipe was successfully updated.' }
